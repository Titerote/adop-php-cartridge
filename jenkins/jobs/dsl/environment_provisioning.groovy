...
// Variables
def environmentTemplateGitUrl = "ssh://jenkins@gerrit:29418/${PROJECT_NAME}/adop-cartridge-php-environment-template"
...
The reference application deploy job is expecting the default environment to be available.''')
    ...
    steps {
        shell('''set +x
                ...
                |    echo "To my taste, this should be the conf: ${PROJECT_NAME}.conf"
